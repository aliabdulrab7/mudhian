...
INSERT INTO "new_DailyDrawer" ("actualBalance", "adminWithdrawals", "bookBalance", "boxesBags", "branchId", "cashPurchases", "createdAt", "customerDepositsIn", "customerDepositsOut", "date", "earnestReceived", "id", "notes", "previousEarnest", "returns", "salariesAdvances", "staffDeposits", "storeExpenses", "totalSales", "updatedAt", "yesterdayBalance") SELECT "actualBalance", "adminWithdrawals", "bookBalance", "boxesBags", "branchId", "cashPurchases", "createdAt", "customerDepositsIn", "customerDepositsOut", "date", "earnestReceived", "id", "notes", "previousEarnest", "returns", "salariesAdvances", "staffDeposits", "storeExpenses", "totalSales", "updatedAt", "yesterdayBalance" FROM "DailyDrawer";
